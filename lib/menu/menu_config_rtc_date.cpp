    ...
    switch(current_step)
    {
        case STEP_EDIT_YEAR: 
        {
            if (button == Button::PRESS_UP) {
                ctx.rtc.change_parameter(Parameter::YEAR, TypeOp::PLUS);
            }
            if (button == Button::PRESS_DOWN) {
                ctx.rtc.change_parameter(Parameter::YEAR, TypeOp::MINUS);
            }
            
            if (button == Button::PRESS_OK) {
                current_step = STEP_EDIT_MONTH;
            }
        } break;
        ...
        {
            if (button == Button::PRESS_UP) {
                ctx.rtc.change_parameter(Parameter::MONTH, TypeOp::PLUS);
            }
            if (button == Button::PRESS_DOWN) {
                ctx.rtc.change_parameter(Parameter::MONTH, TypeOp::MINUS);
            }
            
            if (button == Button::PRESS_OK) {
                current_step = STEP_EDIT_DATE;           
            }
        } break;
        ...
        {
            if (button == Button::PRESS_UP) {
                ctx.rtc.change_parameter(Parameter::DATE, TypeOp::PLUS);
            }
            if (button == Button::PRESS_DOWN) {
                ctx.rtc.change_parameter(Parameter::DATE, TypeOp::MINUS);
            }
