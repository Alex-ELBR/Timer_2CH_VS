...
// Общие операции
constexpr uint16_t CANCEL = 0;
constexpr uint16_t PLUS = 0xFFFF;
constexpr uint16_t MINUS = 0xFFFE;

constexpr uint32_t SPEED_BLINK = 300;   // частота мигания символа

constexpr uint32_t TIME_MAX_BRIGHTNESS = 5; // время свечения на максимальной яркости, сек
...
/****************************************************************************************************
  ...
  и адресах настроек:
*****************************************************************************************************/
constexpr uint8_t CHANNEL_AMOUNT = 2;     // колличество каналов максимум - 9 каналов
constexpr uint8_t TIMER_AMOUNT   = 99;    // колличество таймеров на канал - максимум 99 таймеров
/****************************************************************************************************/
...
constexpr uint32_t THRESHOLD    = 10;      //колличество циклов антидребезга кнопки для фиксации
constexpr uint32_t HOLD         = 1000;    //колличество циклов удержания кнопки для автоперебора значений
constexpr uint32_t BUST         = 50;      //колличество циклов для скорости автоперебора значений
/*****************************************************************************************************/
...
constexpr uint16_t ADDRESS_RTC = (uint16_t)0x68;     //0xD0
constexpr uint16_t ADDRESS_EEPROM = (uint16_t)0x50; //0xA0; //;
/*****************************************************************************************************/
